...
/**
 * @property-read QMX_Collector_Globals_Get $collector
 */
class QMX_Output_Html_Globals_Get extends QM_Output_Html {
	...
	public function panel_menu( array $menu ) {
		...
		$menu['global-get'] = $this->menu( array(
			'title' => '$_GET',
			'id'    => 'query-monitor-extend-globals-get',
			'href'  => '#qm-globals-get',
		) );
...
add_filter( 'qm/outputter/html', static function ( array $output ) : array {
	if ( $collector = QM_Collectors::get( 'globals-get' ) ) {
		$output['globals-get'] = new QMX_Output_Html_Globals_Get( $collector );
	}
