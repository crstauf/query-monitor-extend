...
/**
 * @property-read QMX_Collector_Globals_Post $collector
 */
class QMX_Output_Html_Globals_Post extends QM_Output_Html {
	...
	public function panel_menu( array $menu ) {
		...
		$menu['globals-post'] = $this->menu( array(
			'title' => '$_POST',
			'id'    => 'query-monitor-extend-globals-post',
			'href'  => '#qm-globals-post',
		) );
...
add_filter( 'qm/outputter/html', static function ( array $output ) : array {
	if ( $collector = QM_Collectors::get( 'globals-post' ) ) {
		$output['globals-post'] = new QMX_Output_Html_Globals_Post( $collector );
	}
